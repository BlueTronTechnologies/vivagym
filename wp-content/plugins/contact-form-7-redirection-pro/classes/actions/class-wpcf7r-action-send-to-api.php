...
class WPCF7R_Action_send_to_api extends WPCF7R_Action{
     ...
     * @param  [type] $WPCF7_ContactForm <div description=""></div>
     ...
     * @param  [type] $tags_map [description]
     * @return [type]                  [description]
     *
     * @version 1.1.5
     */
     ...
     * @param  [type] $submited_data [description]
     * @param  [type] $tags_map      [description]
     * @return [type]                [description]
     */
     ...
     * Allow running functions on the submitted values
    ...
    public function run_function( $function , $field_value){
        $function = WPCF7_Redirect_Utilities::get_available_text_functions($function , 'all');
	...
	private function send_lead( $record , $debug = false , $method = 'GET' , $record_type = 'params' ){
		...
		if( ( $method == 'get' || $method == 'GET' ) && ( $record_type == 'params' || $record_type == 'json' ) ){
			$args = array(
				'timeout'     => 100,
				'redirection' => 5,
				'httpversion' => '1.0',
