...
== Changelog ==
= 1.8.9 =
* Rest api Fixed implode function when only one tick box is checked
* Added PUT/DELETE/PATCH methods to API action

= 1.8.8 =
* Rest api added "implode" function for checkbox field

= 1.8.7 =
* Bug fix for checkbox fields not sent correctly

= 1.8.6 =
* Bug fix for wp_remote_get error

= 1.8.5 =
* Added support that allows using the API response

= 1.8.4 =
* Fix api get method

= 1.8.3 =
* Added support for ninja multistep form
