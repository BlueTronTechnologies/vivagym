    	...
    	<div style="margin:0 8px;">
            <div class="postbox">
                ...
                <div class="inside">
                                ...
                                <form method="post" action="options.php">
                                    ...
                                    <label for="epi_random_string_filename">
                                        ...
                                        if ( empty ( get_option( 'epi_random_string_filename' ) ) ) {
                                            ...
                                            echo get_option( 'epi_random_string_filename' );
                                        }
                                        ?>" />
                    ...
                    <?php } else { ?>
                        <p><?php _e( 'You can find the generated CSV file at: ', 'export-post-info' ); ?><a href="<?php $upload_dir = wp_upload_dir(); echo $upload_dir['baseurl'] . '/export-post-info-' . get_option( 'epi_random_string_filename' ) . '.csv'; ?>"><?php $upload_dir = wp_upload_dir(); echo $upload_dir['baseurl'] . '/export-post-info-' . get_option( 'epi_random_string_filename' ) . '.csv'; ?></a></p>
                    <?php } ?>
                    <p><?php _e( 'In the CSV file you get following information for each post: Date published, Post title, URL and First Category (if YOAST SEO is in use and a primarty category is defined, you get the primary category).', 'export-post-info' ); ?></p>
    	...
    	<div style="margin:0 8px;">
            <div class="postbox">
                ...
                <div class="inside">
                    ...
                    <p><?php _e('If you wish to help then use our', 'export-post-info'); echo ' <a href="http://apasionados.es/contacto/index.php?desde=wordpress-org-listposttitles-administracionplugin" target="_blank">'; _e('contact form', 'export-post-info'); echo '</a> '; _e('or contact us on Twitter:', 'export-post-info'); echo ' <a href="https://twitter.com/apasionados" target="_blank">@Apasionados</a>.'; ?></p>
                    <h4 align="right"><img src="<?php echo (plugin_dir_url(__FILE__) . 'love_bw.png'); ?>" /> <span style="color:#b5b5b5;"><?php _e('Developed with love by:', 'export-post-info'); ?></span> <a href="http://apasionados.es/" target="_blank">Apasionados.es</a></h4>
                </div> <!-- .inside -->
            </div> <!-- .postbox -->
		</div> <!-- style margin -->
	</div> <!-- #side-container -->
