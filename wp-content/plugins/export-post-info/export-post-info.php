...
Description: This plugin exports posts Publish Date, Title, URL, Word Count and Categories to a CSV file
Version: 1.0.4
Author: Apasionados
...
function apa_epi_f_plugin_actions($actions, $plugin_file, $plugin_data, $context) {
    array_unshift(
        $actions, '<a href=' . admin_url( 'options-general.php?page=export-post-info-settings' ) . '>' . __('Settings') . '</a>'
		/* . ' | ' . '<a href="https://wordpress.org/support/plugin/XXX" target="_blank">' . __('Support','export-post-info') . '</a>' */
    );
    return $actions;
}
...
function apa_epi_f_activation() {
	if ( version_compare( PHP_VERSION, '5.5', '<' ) ) {
		...
		wp_die( '<h1>' . __('Could not activate plugin: PHP version error', 'export-post-info' ) . '</h1><h2>PLUGIN: <i>' . $plugin_name . ' ' . $plugin_version . '</i></h2><p><strong>' . __('You are using PHP version', 'export-post-info' ) . ' ' . PHP_VERSION . '</strong>. ' . __( 'This plugin has been tested with PHP versions 5.5 and greater.', 'export-post-info' ) . '</p><p>' . __('WordPress itself <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using PHP version 7 or greater</a>. Please upgrade your PHP version or contact your Server administrator.', 'export-post-info' ) . '</p>', __('Could not activate plugin: PHP version error', 'export-post-info' ), array( 'back_link' => true ) );
